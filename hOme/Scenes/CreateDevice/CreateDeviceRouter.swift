...
protocol CreateDeviceRouterInput {
  func navigateToSomewhere()
}

class CreateDeviceRouter: CreateDeviceRouterInput {
  weak var viewController: CreateDeviceViewController!
